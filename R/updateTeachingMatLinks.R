...
#'
#' Function is deprecated. Use [update_drive_links()]
#'
...
message("updateTeachingMatLinks deprecated. Use update_drive_links()")
  NULL
...
#     if (is_empty(current_data$GitHubPath)) {
#       stop("Please enter the GitHub Project Name (gh_proj_name)")
#     } else{
#       gh_proj_name <-
#         current_data$GitHubPath %>% basename %>% tools::file_path_sans_ext()
#     }
