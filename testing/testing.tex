...
\def\Address{
  ...
  \textsuperscript{1} Department X, Institution X,  City X,  State
XX,  Country X
...
XX,  Country X
  ...
  \def\corrAuthor{Co-Author}\def\corrAddress{Laboratory X, Institute X,
Department X, Organization X\\Street X\\City X, State XX, Zip Code
X Country
X}\def\corrEmail{\href{mailto:email@uni.edu}{\nolinkurl{email@uni.edu}}}
...
{\centering \includegraphics[width=85mm,height=85mm]{testing_files/figure-latex/Figure-1-1} 
