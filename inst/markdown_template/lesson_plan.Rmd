...
```{r graph0, echo = TRUE, message=FALSE, fig.show = "hide"}
x <- 0:100
set.seed(999)
...
```{r, Figure-1, ref.label = "graph2", results = "hide", echo = FALSE, message = FALSE, fig.height=4, fig.width=4, fig.align='center', fig.cap='Figure caption', out.width = "85mm", out.height = "85mm"}
